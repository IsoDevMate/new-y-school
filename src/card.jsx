...
function ButtonNext({ disabled, ...attributes }) {
  ...
  export default function GalleryVertical() {
    ...
    return (
      <SfScrollable
        ...
        drag
        slotPreviousButton={
          <ButtonPrev setIsPrevClicked={setIsPrevClicked} setIsStarred={setIsStarred} />
        }
        slotNextButton={
          <ButtonNext setIsNextClicked={setIsNextClicked} setIsStarred={setIsStarred} />
        }
      >
        {CardsData.map(({ imageurl, title, name, price }) => (
          ...
          >
            ...
            <SfLink href="#" className="block text-black">
                {title}
              </SfLink>
  ...
  function ButtonPrev({ setIsPrevClicked, setIsStarred }) {
    return (
      <SfButton
        variant="primary"
        size="sm"
  ...
  function ButtonNext({ setIsNextClicked, setIsStarred }) {
    return (
      <SfButton
        variant="secondary"
        size="sm"
